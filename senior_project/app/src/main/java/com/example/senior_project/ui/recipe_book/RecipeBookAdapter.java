...
public class RecipeBookAdapter extends RecyclerView.Adapter<RecipeBookAdapter.MyViewHolder> {
    Context context;
    ArrayList<RecipeModel> recipeModels;

    public RecipeBookAdapter(Context c, ArrayList<RecipeModel> a) {
        this.context = c;
        this.recipeModels = a;
    }
    @NonNull
    @Override
    public RecipeBookAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater i = LayoutInflater.from(context);
        View v = i.inflate(R.layout.recipes_list_item, parent, false);

        return new RecipeBookAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull RecipeBookAdapter.MyViewHolder holder, int position) {

        String name = recipeModels.get(position).getRecipeName();
        Log.d("success", name);
